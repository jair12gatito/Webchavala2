const profileApiUrl = "http://localhost:3000/api/usuarios/perfil";
const passwordApiUrl = "http://localhost:3000/api/usuarios/password";
const purchasesApiUrl = "http://localhost:3000/api/clientes/compras";
